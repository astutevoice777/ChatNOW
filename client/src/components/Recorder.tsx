...
export default function Recorder() {
  ...
  async function handleStop() {
    try {
      ...
      const errorMessage = err.response?.data?.message || err.message || "Transcription failed. Please try again.";
  ...
  async function handleSemanticSearch() {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.message || err.message || "Semantic search failed.";
      setError(errorMessage);
    } finally {
